...
/*
            ...
            if (leng > 0 || wid > 0)
            {
                {
                    int menu;
                    Rectangle cons1 = new Rectangle();
                    Rectangle cons = new Rectangle(leng, wid);
                    do
                    {
                        Console.WriteLine("Choose any menu");
                        Console.WriteLine("1-Get Rectangle Length ");
                       ...
                       // Rectangle cons = new Rectangle();
                        switch (menu)
                        {
                            ...
                            case 1:
                                Console.WriteLine("Default Length is ");
                                Console.WriteLine(cons1.GetLength());
                                break;
                            case 2:
                                Console.WriteLine("Enter new value to set for length");// fetching parameter from user
                                int lengt = Convert.ToInt32(Console.ReadLine());
                                ...
                                break;
                            case 3:
                                Console.WriteLine("Default Width is");
                                Console.WriteLine(cons1.GetWidth());
                                break;
            ...
            { 
                Console.Write("input value greater than 0 and press enter to continue");
                 Console.ReadLine();
                goto start;
